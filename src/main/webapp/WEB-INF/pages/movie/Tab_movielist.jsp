							...
							<div class="portlet-title" style="z-index: 1;">
								<div class="caption">
									<i class="fa fa-cogs font-green-sharp"></i> <span
										class="caption-subject font-green-sharp bold uppercase koreanStyle">영화
										리스트</span>
								</div>
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<thead>
										<tr>
											...
											<th width="10%">관객수</th>
											<th width="10%"
												onclick="openPopup('http://218.150.181.131/Explain/2.PNG')"
												onMouseOut="toolTip()" onMouseClick="">diameter</th>
											<th width="10%"
												onclick="openPopup('http://218.150.181.131/Explain/3.PNG')"
												onMouseOut="toolTip()" onMouseClick="">pathlength</th>
											<th width="10%"
												onclick="openPopup('http://218.150.181.131/Explain/4.PNG')"
												onMouseOut="toolTip()" onMouseClick="">clustering</th>
											<th width="10%"
												onclick="openPopup('http://218.150.181.131/Explain/5.PNG')"
