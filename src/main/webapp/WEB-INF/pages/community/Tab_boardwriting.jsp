...
<link rel="stylesheet" type="text/css"
	href="http://218.150.181.131/assets/global/plugins/bootstrap-datepicker/css/datepicker.css" />
<link rel="stylesheet" type="text/css"
	href="http://218.150.181.131/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" />
<link
			...
			<div class="page-content">
				<div class="container">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="ecommerce_products_edit.html">Features</a> <i
									...
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-basket font-green-sharp"></i> <span
												...
												Writing </span> <span class="caption-helper">Your comment
												will help us.</span>
										</div>
												...
												<div class="tab-pane active" id="tab_general">
													<div class="form-body">
														<div class="form-group">
															<label class="col-md-2 control-label">글제목: <span
																class="required"> * </span>
															</label>
														...
														<div class="form-group">
															<label class="col-md-2 control-label">말머리: <span
																class="required"> * </span>
															</label>
															<div class="col-md-10">
																<select
																	...
																	<option value="0">질문사항</option>
																	<option value="0">기타</option>
																</select>
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-2 control-label">글 내용: <span
																class="required"> * </span>
															</label>
															<div class="col-md-10">
																<textarea class="form-control"
																	name="product[description]" style="height: 400px;"></textarea>
																<span class="help-block">Please, Tell your
																	thinking on purpose </span>
															</div>
														</div>
													</div>
												</div>
...
<![endif]-->
		...
		<script type="text/javascript"
			src="http://218.150.181.131/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
		<script type="text/javascript"
			src="http://218.150.181.131/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
		<script
			src="http://218.150.181.131/assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js"
			type="text/javascript"></script>
		<script
			src="http://218.150.181.131/assets/global/plugins/bootstrap-touchspin/bootstrap.touchspin.js"
			type="text/javascript"></script>
		<script type="text/javascript"
			src="http://218.150.181.131/assets/global/plugins/fancybox/source/jquery.fancybox.pack.js"></script>
		<script
			src="http://218.150.181.131/assets/global/plugins/plupload/js/plupload.full.min.js"
			type="text/javascript"></script>
		...
		<script
			...
			type="text/javascript"></script>
		<script
			src="http://218.150.181.131/assets/global/scripts/datatable.js"></script>
		<script
			src="http://218.150.181.131/assets/admin/pages/scripts/ecommerce-products-edit.js"></script>
